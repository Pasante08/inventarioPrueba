<?php
    ...
    //$result->fetch_all();
    /*public function select($sqlSelect, $arrayData = array(), $fetchMode = PDO::FETCH_OBJ)
	{
		$query = $this->prepare($sqlSelect);
...
<a id="smallScreen" data-target="#topMenu" data-toggle="collapse" class="btn btn-navbar">
  ...
  <div class="navbar-inner">
    <a class="brand" href="index.html"><img src="themes/images/logo.jpg" alt=""/></a>
                ...
                if($result->num_rows >0) {
                    while($row = $result->fetch_assoc()) {
                        ?>
                            <li class="span3">
                        <div class="thumbnail">
                            <a href="product_details.html"><img src="" alt="Producto"></a>
                            <div class="caption">
                                <h5><?php echo ($row['itemCodigo'].$row['nombre'])?></h5>
                                <p><?php echo $row['marca'] ?></p>
                                <h4 style="text-align:center"><a class="btn" href="product_details.html"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#"><?php echo $row['precio'] ?></a></h4>
                            </div>
                        </div>
                    </li>
                    <?php
